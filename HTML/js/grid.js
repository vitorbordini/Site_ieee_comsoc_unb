...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$twitter = $('<a href="" class="social"><i class="fa fa-linkedin"></i></a>');
			this.$facebook = $('<a href="" class="social"><i class="fa fa-github"></i></a>');
			this.$git = $('<a href="" class="social"><i class="fa fa-github"></i></a>');
		...
		update : function( $item ) {
			...
			this.$twitter.attr('href', 'https://br.linkedin.com/in/'+eldata.twitter);
			this.$facebook.attr('href', 'https://github.com/'+eldata.facebook);
